          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex-1 bg-primary-100 hover:bg-primary-200 active:bg-primary-300 text-primary-800 font-semibold py-3.5 px-6 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg active:scale-[0.98] min-h-[52px] flex items-center justify-center gap-2"
                style={{ touchAction: 'manipulation' }}
              >
              ...
              <button
                ...
                className="flex-1 bg-blue-500 hover:bg-blue-600 active:bg-blue-700 text-white font-semibold py-3.5 px-6 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg active:scale-[0.98] min-h-[52px] flex items-center justify-center gap-2"
                style={{ touchAction: 'manipulation' }}
              >
              ...
              <button
                ...
                className="flex-1 bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-700 font-semibold py-3.5 px-6 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg active:scale-[0.98] min-h-[52px] flex items-center justify-center gap-2"
                style={{ touchAction: 'manipulation' }}
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
